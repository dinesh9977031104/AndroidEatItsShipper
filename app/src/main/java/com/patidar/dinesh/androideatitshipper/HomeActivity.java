...
import com.patidar.dinesh.androideatitshipper.ViewHolder.OrderViewHolder;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void loadAllOrderNeedShip(String phone) {
        ...
        FirebaseRecyclerOptions<Request> listOrder = new FirebaseRecyclerOptions.Builder<Request>()
                .setQuery(orderInChildOfShipper,Request.class).build();
                ...
                viewHolder.btnShipping.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                      //  Toast.makeText(HomeActivity.this, "Implement late !!!", Toast.LENGTH_SHORT).show();
                        ...
                        startActivity(new Intent(HomeActivity.this, TrakingOrder.class));
                    }
                });
            }
            ...
            case Common.REQUEST_CODE: {
                if (grantResults.length > 0) {
                    if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Toast.makeText(this, "You should assign permision", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            break;
